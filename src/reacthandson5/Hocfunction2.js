...
const Hocfunction2 = (props) => {
    return (
        <>
            <div style={{ backgroundColor: 'lightblue' }}>{<props.val></props.val>}
                <h2 style={{ color: '#660000' }}>BENIFITS OF USING HOC:</h2>
                <ol >
